...
const ProductCard = ({ product }) => {
    ...
    return (
        <>
            ...
            <div className='bg-white text-gray-700 w-72 min-h-[10rem] shadow-lg rounded-md overflow-hidden transition hover:scale-110 ease-in-out delay-150 duration-500 hover:shadow-2xl'>
